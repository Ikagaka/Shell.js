...
class Shell extends eventemitter3_1.default {
    ...
    loadDescript() {
        ...
        var getName = (dic, reg) => Object.keys(dic).filter((name) => reg.test(name))[0] || "";
    ...
    getPNGFromDirectory(filename) {
        ...
        var render = new SurfaceRender_1.default(SurfaceUtil.createCanvas());
    ...
    attachSurface(canvas, scopeId, surfaceId) {
        ...
        var srf = new Surface_1.default(canvas, scopeId, _surfaceId, this);
