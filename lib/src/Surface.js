...
class Surface {
    constructor(canvas, scopeId, surfaceId, shell) {
        ...
        this.bufRender = new SurfaceRender_1.default(this.bufferCanvas);
        this.elmRender = new SurfaceRender_1.default(this.element);
        this.talkCount = 0;
        this.talkCounts = {};
    ...
    updateBind() {
        ...
        this.surfaceNode.animations.forEach((anim) => {
            ...
            if (this.shell.bindgroup[this.scopeId] == null)
                return;
            if (this.shell.bindgroup[this.scopeId][is] == null)
                return;
            if (!/^bind/.test(interval))
                return;
    ...
    render() {
        ...
        layers.forEach((pattern, i) => {
            ...
            var rndr = new SurfaceRender_1.default(SurfaceUtil.copy(base)); // 対象サーフェスのbaseサーフェス(surface*.png)の上に
