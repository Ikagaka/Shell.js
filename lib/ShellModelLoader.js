...
function load(directory) {
    return loadDescript(directory)
        .then(({ descript, descriptJSON, config }) => loadSurfacesTxt(directory)
        .then(({ surfacesTxt, surfaceDefTree }) => loadSurfaceTable(directory)
        .then(() => loadSurfacePNG(directory, surfaceDefTree)
        .then((surfaceDefTree) => {
