  ...
  Named = (function(superClass) {
    ...
    Named.prototype.initEventListener = function() {
      (function() {
        ...
        relLeft = relTop = 0;
        $target = null;
        return this.shell.on("mouse", (function(_this) {
          return function(ev) {
            var $scope, $surfaceCanvas, alignment, bottom, clientX, clientY, left, pageX, pageY, ref, ref1, ref2, right, top;
            ...
            switch (ev.type) {
              ...
              case "mousemove":
                if ($target != null) {
                  ...
                  alignment = _this.shell.descript["seriko.alignmenttodesktop"] || _this.shell.descript[(SurfaceUtil.scope(ev.scopeId)) + ".alignmenttodesktop"] || "bottom";
                  switch (alignment) {
                    case "free":
                      break;
                    case "top":
      ...
      (function() {
        ...
        relLeft = relTop = 0;
        $target = null;
        return this.balloon.on("mouse", (function(_this) {
          return function(ev) {
