...
var _EventBinder2 = require("./EventBinder");

var Surface = (function (_EventBinder) {
    _inherits(Surface, _EventBinder);

    function Surface(canvas, scopeId, surfaceId, shell) {
        _classCallCheck(this, Surface);

        _get(Object.getPrototypeOf(Surface.prototype), "constructor", this).call(this, canvas);
        this.element = canvas;
