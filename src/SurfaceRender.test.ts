...
QUnit.module('Shell.SR.SurfaceRender');

QUnit.test('SR.SurfaceRender#clear', function(assert) {
  var done;
  done = assert.async();
  return Promise.all([SU.fetchImageFromURL("src/surface0730.png")]).then(function(arg) {
    var alpha, cnv, ctx, imagedata, png, render;
    png = arg[0];
    render = new SR.SurfaceRender();
    render.base(SU.pna({
      cnv: null,
      png: png,
      pna: null
...
QUnit.test('SR.SurfaceRender#base', function(assert) {
  var done;
  done = assert.async();
  return Promise.all([SU.fetchImageFromURL("src/surface0.png")]).then(function(arg) {
...
QUnit.test('SR.SurfaceRender#overlay', function(assert) {
  var done;
  done = assert.async();
  return Promise.all([SU.fetchImageFromURL("src/surface0.png"), SU.fetchImageFromURL("src/surface0730.png"), SU.fetchImageFromURL("src/surface0730.pna")]).then(function(arg) {
    ...
    megane_on_base_render = new SR.SurfaceRender();
    megane_on_base_render.base(base);
    base_on_megane_render = new SR.SurfaceRender();
    base_on_megane_render.base(megane);
    megane_on_base_negative_render = new SR.SurfaceRender();
    megane_on_base_negative_render.base(base);
    base_on_megane_negative_render = new SR.SurfaceRender();
...
QUnit.test('SR.SurfaceRender#overlayfast', function(assert) {
  var done;
  done = assert.async();
  return Promise.all([SU.fetchImageFromURL("src/surface0.png")]).then(function(arg) {
...
QUnit.test('SR.SurfaceRender#interpolate', function(assert) {
  var done;
  done = assert.async();
  return Promise.all([SU.fetchImageFromURL("src/surface0.png")]).then(function(arg) {
    var base, frame, img, render, transparent;
...
QUnit.test('SR.SurfaceRender#replace', function(assert) {
  var done;
  done = assert.async();
  return Promise.all([SU.fetchImageFromURL("src/surface0.png")]).then(function(arg) {
    var base, frame, img, render, transparent;
...
QUnit.test('SR.SurfaceRender#move', function(assert) {
  var done;
  done = assert.async();
  return Promise.all([SU.fetchImageFromURL("src/surface0.png")]).then(function(arg) {
...
QUnit.test('SR.SurfaceRender#reduce', function(assert) {
  var done;
  done = assert.async();
  return Promise.all([SU.fetchImageFromURL("src/surface0.png")]).then(function(arg) {
...
QUnit.test('SR.SurfaceRender#asis', function(assert) {
  var done;
  done = assert.async();
  return Promise.all([SU.fetchImageFromURL("src/surface0.png")]).then(function(arg) {
    var base, frame, img, render;
...
QUnit.test('SR.SurfaceRender#composeElements', function(assert) {
  var done;
  done = assert.async();
  return Promise.all([SU.fetchImageFromURL("src/surface0.png"), SU.fetchImageFromURL("src/surface0730.png"), SU.fetchImageFromURL("src/surface0730.pna")]).then(function(arg) {
...
QUnit.test('SR.SurfaceRender#drawRegions', function(assert) {
  var done;
  done = assert.async();
  return Promise.all([SU.fetchImageFromURL("src/surface0.png")]).then(function(arg) {
    var base, frame, img, render;
...
QUnit.test('SR.SurfaceRender#overlay negative', function(assert) {
  var done;
  done = assert.async();
  return Promise.all([SU.fetchImageFromURL("src/surface0.png"), SU.fetchImageFromURL("src/surface0730.png"), SU.fetchImageFromURL("src/surface0730.pna")]).then(function(arg) {
    var base, frame, img, megane, pna, png, render;
    ...
    assert.ok(true);
    frame = SU.craetePictureFrame("SurfaceRender#overlay negative");
    frame.add(render.cnv, "result");
    return done();
  });
});

QUnit.test('SR.SurfaceRender#overlay base on megane', function(assert) {
  var done;
  done = assert.async();
  return Promise.all([SU.fetchImageFromURL("src/surface0.png"), SU.fetchImageFromURL("src/surface0730.png"), SU.fetchImageFromURL("src/surface0730.pna")]).then(function(arg) {
    var base, frame, img, megane, pna, png, render;
...
QUnit.test('SR.SurfaceRender#overlay base on megane super', function(assert) {
  var done;
  done = assert.async();
  return Promise.all([SU.fetchImageFromURL("src/surface0.png"), SU.fetchImageFromURL("src/surface0730.png"), SU.fetchImageFromURL("src/surface0730.pna")]).then(function(arg) {
    var base, frame, img, megane, pna, png, render;
