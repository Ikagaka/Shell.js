...
module.exports={
  ...
  "scripts": {
    ...
    "build": "cake index; npm run clean && tsc   && gulp build&& browserify es5/index.js --standalone Shell -o dist/Shell.js; npm run cake",
    ...
    "cake": "cake clean; cake test; cake sandbox;",
